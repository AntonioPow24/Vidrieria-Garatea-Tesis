...
const AdminDashboardTop = ({
  ...
  return (
    <section className='flex flex-col justify-between gap-[10px] p-[12px] bg-dashboardPurpleBg h-full rounded-xl shadow-[0px_4px_20px_rgba(0,0,0,0.1)] dark:shadow-[0px_4px_20px_rgba(0,0,0,0.2)] transition-all duration-300'>
      <div className='flex justify-center items-center 1442:justify-start'>
        <h3 className='text-text-white text-[14px] 1442:text-[16px]'>Mas vendido del Mes</h3>
      </div>

      <div className='flex flex-col justify-between flex-1 gap-[10px] items-center 1442:flex-row'>
