...
const AdminDashboardStat = ({title, statNumber, icon}) => {
  ...
  return (
    <article className='bg-adminBgWhite p-[12px] rounded-xl flex gap-[12px] dark:bg-appBgBlack transition-all duration-300 justify-between items-center shadow-[0px_4px_20px_rgba(0,0,0,0.1)] dark:shadow-[0px_4px_20px_rgba(0,0,0,0.2)]'>
      <div className='flex flex-col gap-[12px] justify-between'>
        ...
        <div className=' transition-all duration-300 text-[26px] text-[#707070]  dark:text-textWhiteTransparent font-semibold'>
            {statNumber}
        </div>
      </div>
