...
const ProductTRCard = ({productId, titleName, category, valorization, stock, isAvailable, price,imageUrl  }) => {


    const { deleteProduct } = useAdminProductsContext()
        ...
        <td className='text-center'>
            <div>
                <span 
                    ...
                    ${ isAvailable? 'text-success' : 'text-logOut' } transition-all duration-300 text-xl cursor-default`}
                >
